# Oficina de Trabajo Virtual — v4.7.0
...
Usa el `render.yaml` incluido y realiza un nuevo deploy. La aplicación escucha en el puerto proporcionado por `PORT` y usa la base de datos SQLite configurada por el proyecto.
